    ...
    return (
        <article className="article">
            <div className="imgContainer">
                <img src="https://nordski.ru/images/blog/luchshie-marafony-rossii-001.jpg" alt="Article" className="article-image"/>
            </div>
            <div className="article-content">
                <span className="typeOfEvent">
                ...
                <div className="article-info-row">
                    ...
                    <span className="article-deadline">
                        ...
                        Reg. Deadline: 19 фев 2026
                    </span>
                </div>

                <div className="article-info-row">
                    <span className="nowPeople">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                ...
                <button className="article-button">more</button>
            </div>
        </article>
    );
}
